...
#define CUSTOM_MENDEL_NAME  	"P802Y"
#define	MACHINE_FW_VERSION		"P802YA_V1.7"
...
//    You must specify the X & Y coordinates of all 3 points
  ...
  #define X_PROBE_OFFSET_FROM_EXTRUDER 		-39//-25
  #define Y_PROBE_OFFSET_FROM_EXTRUDER 		-10//-29
  #define Z_PROBE_OFFSET_FROM_EXTRUDER 		-6.25//-12.35
...
#define DEFAULT_MAX_FEEDRATE          {400, 400, 8, 100}    			// (mm/sec)
